    ...
    <div className="flex items-center gap-2 text-gray-400">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-500 mb-4">Gestiona tus productos antes de proceder al pago</p>
          ...
          {cart.length === 0 ? (
            ...
            cart.map((item, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <span className="bg-gray-100 px-3 py-1 rounded text-sm">{item.quantity}</span>
                  <button
                    onClick={() =>
                      removeFromCart({
          ...
          <button className="text-sm text-red-600 hover:underline mt-4 flex items-center gap-1">
            ← Continuar comprando
          </button>
        </div>
