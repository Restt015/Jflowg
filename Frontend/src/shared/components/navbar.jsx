    ...
    <>
      <nav className="fixed top-6 left-0 w-full z-40 bg-rose-100 shadow-md px-6 py-4 rounded-b-lg">
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <Link to="/Home" className="text-gray-800 font-bold text-xl">
            Jflowg
          </Link>
          ...
          <div className="hidden md:flex items-center gap-6">
            <button className="text-pink-900 text-xl hover:text-rose-600">
              <FaHeart />
            </button>

            <button onClick={() => setIsCartOpen(true)} className="text-pink-900 text-xl hover:text-rose-600">
              <FaShoppingCart />
            </button>
            ...
            <div className="relative flex items-center justify-center" ref={dropdownRef}>
              <button
                ...
                className="text-pink-900 text-xl hover:text-rose-600"
              >
                <FaUserCircle className="text-[1.25rem]" />
              </button>
